...
if(CMAKE_CXX_COMPILER_ID MATCHES ".*Clang")
    if(CMAKE_CXX_COMPILER_VERSION VERSION_GREATER_EQUAL ${APE_TEMPLATE_MIN_CLANG_VERSION})
        ...
        message(FATAL_ERROR "Clang version ${CMAKE_CXX_COMPILER_VERSION} does not fully support C++ modules. Version ${APE_TEMPLATE_MIN_CLANG_VERSION}+ required.")
    endif()
...
elseif(CMAKE_CXX_COMPILER_ID STREQUAL "GNU")
    if(CMAKE_CXX_COMPILER_VERSION VERSION_GREATER_EQUAL ${APE_TEMPLATE_MIN_GCC_VERSION})
        ...
        message(FATAL_ERROR "GCC version ${CMAKE_CXX_COMPILER_VERSION} does not fully support C++ modules. Version ${APE_TEMPLATE_MIN_GCC_VERSION}+ required.")
    endif()
...
elseif(MSVC)
    if(CMAKE_CXX_COMPILER_VERSION VERSION_GREATER_EQUAL ${APE_TEMPLATE_MIN_MSVC_VERSION})
        ...
        message(FATAL_ERROR "MSVC version ${CMAKE_CXX_COMPILER_VERSION} does not fully support C++ modules. Version ${APE_TEMPLATE_MIN_MSVC_VERSION}+ required.")
    endif()
else()
