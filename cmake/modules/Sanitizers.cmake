...
if(APE_TEMPLATE_ENABLE_SANITIZERS)
    if(MSVC)
        ...
        if(APE_TEMPLATE_SANITIZER_TYPE STREQUAL "address")
            add_compile_options(/fsanitize=address)
            message(STATUS "AddressSanitizer enabled (MSVC)")
        else()
            message(WARNING "MSVC only supports AddressSanitizer. Requested: ${APE_TEMPLATE_SANITIZER_TYPE}")
        endif()
    ...
    elseif(CMAKE_CXX_COMPILER_ID MATCHES ".*Clang" OR CMAKE_CXX_COMPILER_ID STREQUAL "GNU")
        ...
        elseif(APE_TEMPLATE_SANITIZER_TYPE STREQUAL "memory")
        ...
        elseif(APE_TEMPLATE_SANITIZER_TYPE STREQUAL "thread")
            set(SANITIZER_FLAGS "-fsanitize=thread")
            message(STATUS "ThreadSanitizer enabled")

        elseif(APE_TEMPLATE_SANITIZER_TYPE STREQUAL "undefined")
            set(SANITIZER_FLAGS "-fsanitize=undefined -fno-omit-frame-pointer")
            message(STATUS "UndefinedBehaviorSanitizer enabled")

        elseif(APE_TEMPLATE_SANITIZER_TYPE STREQUAL "leak")
            set(SANITIZER_FLAGS "-fsanitize=leak")
            message(STATUS "LeakSanitizer enabled")

        else()
            message(WARNING "Unknown sanitizer type: ${APE_TEMPLATE_SANITIZER_TYPE}")
        endif()
